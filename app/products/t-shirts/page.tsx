...
export default function TShirtsPage() {
  ...
  const { products, loading, error } = useProductsByCategory("t-shirts")

  const handleOrderNow = (product: any) => {
    router.push(`/products/t-shirts/${product.id}`)
  }
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-center flex-1">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">T-SHIRTS</h1>
            <p className="text-gray-300">مجموعة متنوعة من التيشيرتات العصرية</p>
          </div>
              ...
              >
                <CardContent className="p-0">
                  <div className="relative">
                    <Link href={`/products/t-shirts/${product.id}`}>
                  ...
                  <div className="p-4">
                    ...
                    <Button
                      onClick={() => router.push(`/products/t-shirts/${product.id}`)}
