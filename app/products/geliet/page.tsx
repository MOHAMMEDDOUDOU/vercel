...
export default function GelietPage() {
  const router = useRouter()
  const { toast } = useToast()
  const { products, loading, error } = useProductsByCategory("geliet")

  const handleOrderNow = (product: any) => {
    router.push(`/products/geliet/${product.id}`)
  }
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-center flex-1">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">GILETS</h1>
            <p className="text-gray-300">مجموعة متنوعة من الجيليه العصري</p>
          </div>
              ...
              >
                <CardContent className="p-0">
                  <div className="relative">
                    <Link href={`/products/geliet/${product.id}`}>
                  ...
                  <div className="p-4">
                    ...
                    <Button
                      onClick={() => router.push(`/products/geliet/${product.id}`)}
