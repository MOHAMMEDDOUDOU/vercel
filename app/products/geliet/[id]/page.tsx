...
import { Truck, Building2, Loader2, Star, ShoppingCart, ChevronLeft, ChevronRight, AlertCircle, CheckCircle } from "lucide-react"
...
export default function GelietDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
  ...
  if (loadingProduct) {
    return <div className="min-h-screen flex items-center justify-center text-xl">جاري تحميل المنتج...</div>
  }
        ...
        <div className="container mx-auto px-4">
          ...
          <nav className="mb-8">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <Link href="/products/geliet" className="hover:text-orange-600 transition-colors">
                الجيليه
              </Link>
              <span>/</span>
              ...
              <div className="xl:hidden bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                ...
                <div className="flex items-center mb-4">
                  ...
                  {product.originalPrice && (
                    <span className="text-lg text-gray-400 line-through mr-3">{product.originalPrice} دج</span>
                  )}
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="hidden xl:block bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                ...
                <div className="flex items-center mb-6">
                  ...
                  {product.originalPrice && (
                    <span className="text-xl text-gray-400 line-through mr-3">{product.originalPrice} دج</span>
                  )}
                </div>
              ...
              <Card className="border-2 border-orange-200 shadow-xl bg-gradient-to-br from-white to-orange-50">
                ...
                <CardContent className="space-y-6 pt-6">
                    ...
                    <Select value={deliveryType} onValueChange={(value: "home" | "office") => setDeliveryType(value)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="office">
                          <div className="flex items-center">
                            <Building2 className="ml-2 h-4 w-4 text-orange-500" />
                            <div>
                              <div className="font-medium">توصيل للمكتب</div>
                              <div className="text-xs text-gray-500">استلام من مكتب ZR Express</div>
                            </div>
                          </div>
                        </SelectItem>
                      </SelectContent>
                  ...
                  {deliveryType === "home" && (
                    <div>
                      ...
                      <Select value={commune} onValueChange={setCommune} disabled={!wilaya}>
                        <SelectTrigger className="border-orange-200 focus:border-orange-500">
                          <SelectValue placeholder={wilaya ? "اختر البلدية" : "اختر الولاية أولاً"} />
                        </SelectTrigger>
                        <SelectContent>
                  ...
                  <div className="bg-gradient-to-r from-gray-50 to-orange-50 p-6 rounded-xl border border-orange-200">
                    <h3 className="font-bold text-gray-900 mb-4 text-center">ملخص الطلب</h3>
